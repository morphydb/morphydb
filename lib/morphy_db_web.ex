defmodule MorphyDbWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: MorphyDbWeb
  ...
  def view do
    quote do
      ...
      use Surface.View, root: "lib/morphy_db_web/templates"
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {MorphyDbWeb.LayoutView, "live.html"}
